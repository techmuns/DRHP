...
_COLUMNS = [
    ...
    ("Fresh Shares", lambda f: f.issue.fresh_shares),
    ("OFS Shares", lambda f: f.issue.ofs_shares),
    ("Total Shares", lambda f: f.issue.total_shares),
    ("Face Value", lambda f: f.issue.face_value),
    ("Market Cap (Cr)", lambda f: f.issue.market_cap_cr),
    ("Issue/MktCap %", lambda f: f.issue.issue_to_mktcap_pct),
